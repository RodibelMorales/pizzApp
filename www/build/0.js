...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__info_profile__ = __webpack_require__(438);
...
var _error = __webpack_require__(422);
...
var _metadata = __webpack_require__(429);

var MetadataUtils = _interopRequireWildcard(_metadata);

var _type = __webpack_require__(421);
...
var _json = __webpack_require__(442);

var json = _interopRequireWildcard(_json);

var _location = __webpack_require__(426);

var _path = __webpack_require__(435);
...
var _url = __webpack_require__(430);
...
var _args = __webpack_require__(428);

var args = _interopRequireWildcard(_args);

var _blob = __webpack_require__(436);
...
var _requests = __webpack_require__(437);

var requests = _interopRequireWildcard(_requests);

var _string = __webpack_require__(427);
...
var _task = __webpack_require__(445);
...
var _array = __webpack_require__(431);
...
var _requestinfo = __webpack_require__(444);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase_storage__ = __webpack_require__(439);
...
var InfoProfilePage = (function () {
    function InfoProfilePage(navCtrl, navParams, alertCtrl, database, afAuth, formBuild) {
        ...
        this.storageRef = __WEBPACK_IMPORTED_MODULE_5_firebase_app__["storage"]().ref();
    }
    ...
    InfoProfilePage.prototype.uploadImgProfile = function (ev) {
        var _this = this;
        this.afAuth.authState.take(1).subscribe(function (auth) {
            var fileRef = _this.storageRef.child("/images_profiles/" + auth.uid + "/" + ev.target.files[0]['name']);
            var uploadTask = fileRef.put(ev.target.files[0]);
            return new Promise(function (resolve, reject) {
                uploadTask.on(__WEBPACK_IMPORTED_MODULE_5_firebase_app__["storage"].TaskEvent.STATE_CHANGED, function (snapshot) {
                    ...
                    _this.imgprofile = uploadTask.snapshot.downloadURL;
                    _this.info_profile.img_profile = uploadTask.snapshot.downloadURL;
                    _this.info_profile.email = auth.email;
                });
            });
        });
    };
...
var _taskenums = __webpack_require__(432);

var _xhriopool = __webpack_require__(440);

var _reference = __webpack_require__(434);

var _service = __webpack_require__(449);
...
var _promise_external = __webpack_require__(423);
...
var _xhrio = __webpack_require__(433);
...
var _observer = __webpack_require__(446);

var _tasksnapshot = __webpack_require__(447);
...
var _async = __webpack_require__(448);
...
var _authwrapper = __webpack_require__(450);
...
var _error2 = __webpack_require__(422);

var errorsExports = _interopRequireWildcard(_error2);

var _failrequest = __webpack_require__(451);
...
var _requestmap = __webpack_require__(452);
...
var _backoff = __webpack_require__(454);
